...
const EditProduct = () => {
  ...
  useEffect(() => {
    const fetchProduct = async () => {
      try {
        const res = await axios.get(`https://backendassignmenttt.onrender.com/api/products/${id}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.put(`https://backendassignmenttt.onrender.com/api/products/${id}`, formData, {
